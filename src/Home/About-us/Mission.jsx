...
const Mission = () => {
    return (
        <>
            <div className="mission-main-page">
                <div className="back-poster">
                    <div className="text">
                        <div className="title">
                            <h2>Our Mission</h2>
                            <p>Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; Praesent molestie eu turpis nec molestie. Nam auctor magna mauris.</p>
                        </div>
                                ...
                                <div className="icon">
                                    <div className="out-line">
                                        ...
                                        <div className="inner-icon">
                                            <img src="assets/img/lineal-ribbons.png" alt="" />
                                        </div>
                                    </div>
                                </div>
                                <div className="info">
                                    <h3>High Standards</h3>
                                    <p>Adipisci blandit mauris massa, accumsan vestibulum tortor feugiat, nulla.</p>
                                </div>
                            </div>
                            <div className="item">
                                <div className="icon">
                                    <div className="out-line">
                                        ...
                                        <div className="inner-icon">
                                            <img src="assets/img/apple-pie.png" alt="" />
                                        </div>
                                    </div>
                                </div>
                                <div className="info">
